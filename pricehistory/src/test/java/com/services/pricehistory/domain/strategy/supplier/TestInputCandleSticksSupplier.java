 ...
 */
public class TestInputCandleSticksSupplier implements Supplier<List<CandleStick>> {
    ...
    public List<CandleStick> get() {
        ...
        candleSticks.add(buildCandleStick(testTime.plus(2, ChronoUnit.MINUTES), new BigDecimal(0),
        ...
        candleSticks.add(buildCandleStick(testTime.plus(4, ChronoUnit.MINUTES), new BigDecimal(0),
                new BigDecimal(0), new BigDecimal(0), new BigDecimal(0),
